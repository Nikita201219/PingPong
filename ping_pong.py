...
class Player(GameSprite):
    def update_l(self):
        ...
        if key_pressed[K_W] and self.rect.y < 450:#если нажата стрелочка в право и координаты по иксу меньше 645
            self.rect.x += self.speed#перемещаем его по иксу на столько сколько равна скорость игрока
        if key_pressed[K_S] and self.rect.y > 10:#если нажата стрелочка в лево и координаты по иксу больше 0
            self.rect.x -= self.speed#перемещаем его по иксу на столько сколько равна скорость игрока
    ...
    def update_r(self):
        key_pressed = key.get_pressed()#если какая-тот клавиша нажата то в key_pressed лежит True
        #управление первым спрайтом (то  что снизу)
        if key_pressed[K_UP] and self.rect.y < 450:#если нажата стрелочка в право и координаты по иксу меньше 645
            self.rect.x += self.speed#перемещаем его по иксу на столько сколько равна скорость игрока
        if key_pressed[K_DOWN] and self.rect.y > 10:#если нажата стрелочка в лево и координаты по иксу больше 0
            self.rect.x -= self.speed#перемещаем его по иксу на столько сколько равна скорость игрока
        #управление первым спрайтом (то что сверху)
...
while game:#пока game будет True цикл не закончится
    ...
    if finish != True:
        ...
        player1.update()#теперь главный герой может двигаться при нажатии на стрелочки
        player2.update()#теперь главный герой может двигаться при нажатии на стрелочки
